.class public abstract Lcom/google/sigma_gson/reflect/TypeToken;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/sigma_gson/reflect/TypeToken$1;,
        Lcom/google/sigma_gson/reflect/TypeToken$SimpleTypeToken;
    }
.end annotation
...
.method protected constructor <init>()V
    ...
    .prologue
    .line 64
    .local p0, this:Lcom/google/sigma_gson/reflect/TypeToken;,"Lcom/google/sigma_gson/reflect/TypeToken<TT;>;"
    ...
    invoke-static {v0}, Lcom/google/sigma_gson/reflect/TypeToken;->getSuperclassTypeParameter(Ljava/lang/Class;)Ljava/lang/reflect/Type;

    move-result-object v0

    iput-object v0, p0, Lcom/google/sigma_gson/reflect/TypeToken;->type:Ljava/lang/reflect/Type;

    .line 66
    iget-object v0, p0, Lcom/google/sigma_gson/reflect/TypeToken;->type:Ljava/lang/reflect/Type;

    invoke-static {v0}, Lcom/google/sigma_gson/reflect/TypeToken;->getRawType(Ljava/lang/reflect/Type;)Ljava/lang/Class;

    move-result-object v0

    iput-object v0, p0, Lcom/google/sigma_gson/reflect/TypeToken;->rawType:Ljava/lang/Class;
...
.method private constructor <init>(Ljava/lang/reflect/Type;)V
    ...
    invoke-static {p1, v0}, Lcom/google/sigma_gson/reflect/TypeToken;->nonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 75
    iput-object p1, p0, Lcom/google/sigma_gson/reflect/TypeToken;->type:Ljava/lang/reflect/Type;

    .line 76
    return-void
.end method

.method synthetic constructor <init>(Ljava/lang/reflect/Type;Lcom/google/sigma_gson/reflect/TypeToken$1;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .line 45
    .local p0, this:Lcom/google/sigma_gson/reflect/TypeToken;,"Lcom/google/sigma_gson/reflect/TypeToken<TT;>;"
    invoke-direct {p0, p1}, Lcom/google/sigma_gson/reflect/TypeToken;-><init>(Ljava/lang/reflect/Type;)V
...
.method static fromSuperclassTypeParameter(Ljava/lang/Class;)Lcom/google/sigma_gson/reflect/TypeToken;
    .locals 1
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    new-instance v0, Lcom/google/sigma_gson/reflect/TypeToken$SimpleTypeToken;

    invoke-direct {v0, p0}, Lcom/google/sigma_gson/reflect/TypeToken$SimpleTypeToken;-><init>(Ljava/lang/reflect/Type;)V

    return-object v0
.end method

.method public static get(Ljava/lang/Class;)Lcom/google/sigma_gson/reflect/TypeToken;
    .locals 1
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public static get(Ljava/lang/reflect/Type;)Lcom/google/sigma_gson/reflect/TypeToken;
    .locals 1
    .parameter "type"
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private static getRawType(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    invoke-static {v3, v4}, Lcom/google/sigma_gson/reflect/TypeToken;->buildUnexpectedTypeError(Ljava/lang/reflect/Type;[Ljava/lang/Class;)Ljava/lang/AssertionError;
    ...
    invoke-static {v4}, Lcom/google/sigma_gson/reflect/TypeToken;->getRawType(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    invoke-static {p0, v4}, Lcom/google/sigma_gson/reflect/TypeToken;->buildUnexpectedTypeError(Ljava/lang/reflect/Type;[Ljava/lang/Class;)Ljava/lang/AssertionError;
...
.method private static isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/GenericArrayType;)Z
    ...
    invoke-static {v1, v2, v3}, Lcom/google/sigma_gson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
...
.method private static isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
    ...
    .line 228
    :cond_1
    invoke-static/range {p0 .. p0}, Lcom/google/sigma_gson/reflect/TypeToken;->getRawType(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    invoke-static {v9, v0, v1}, Lcom/google/sigma_gson/reflect/TypeToken;->typeEquals(Ljava/lang/reflect/ParameterizedType;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
    ...
    invoke-static {v7, v0, v15}, Lcom/google/sigma_gson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
    ...
    invoke-static {v10, v0, v15}, Lcom/google/sigma_gson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
...
.method private static typeEquals(Ljava/lang/reflect/ParameterizedType;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
    ...
    invoke-static {v4, v5, p2}, Lcom/google/sigma_gson/reflect/TypeToken;->matches(Ljava/lang/reflect/Type;Ljava/lang/reflect/Type;Ljava/util/Map;)Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 320
    :cond_0
    instance-of v1, p1, Lcom/google/sigma_gson/reflect/TypeToken;
    ...
    .line 323
    check-cast v0, Lcom/google/sigma_gson/reflect/TypeToken;

    .line 324
    .local v0, t:Lcom/google/sigma_gson/reflect/TypeToken;,"Lcom/google/sigma_gson/reflect/TypeToken<*>;"
    iget-object v1, p0, Lcom/google/sigma_gson/reflect/TypeToken;->type:Ljava/lang/reflect/Type;

    iget-object v2, v0, Lcom/google/sigma_gson/reflect/TypeToken;->type:Ljava/lang/reflect/Type;
...
.method public getRawType()Ljava/lang/Class;
    ...
    .line 137
    .local p0, this:Lcom/google/sigma_gson/reflect/TypeToken;,"Lcom/google/sigma_gson/reflect/TypeToken<TT;>;"
    iget-object v0, p0, Lcom/google/sigma_gson/reflect/TypeToken;->rawType:Ljava/lang/Class;
...
.method public isAssignableFrom(Lcom/google/sigma_gson/reflect/TypeToken;)Z
    .locals 1
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 184
    .local p0, this:Lcom/google/sigma_gson/reflect/TypeToken;,"Lcom/google/sigma_gson/reflect/TypeToken<TT;>;"
    .local p1, token:Lcom/google/sigma_gson/reflect/TypeToken;,"Lcom/google/sigma_gson/reflect/TypeToken<*>;"
    invoke-virtual {p1}, Lcom/google/sigma_gson/reflect/TypeToken;->getType()Ljava/lang/reflect/Type;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/sigma_gson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;)Z
...
.method public isAssignableFrom(Ljava/lang/Class;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/google/sigma_gson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;)Z
...
.method public isAssignableFrom(Ljava/lang/reflect/Type;)Z
    ...
    invoke-static {p1}, Lcom/google/sigma_gson/reflect/TypeToken;->getRawType(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    invoke-static {p1, v0, v1}, Lcom/google/sigma_gson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/ParameterizedType;Ljava/util/Map;)Z
    ...
    invoke-static {p1, v0}, Lcom/google/sigma_gson/reflect/TypeToken;->isAssignableFrom(Ljava/lang/reflect/Type;Ljava/lang/reflect/GenericArrayType;)Z
    ...
    invoke-static {v0, v3}, Lcom/google/sigma_gson/reflect/TypeToken;->buildUnexpectedTypeError(Ljava/lang/reflect/Type;[Ljava/lang/Class;)Ljava/lang/AssertionError;
